...
function init() {
    ...
    const textures = {
        map: textureLoader.load('src/textures/plaster_color.jpg'),
        normalMap: textureLoader.load('src/textures/plaster_normal.jpg'),
        roughnessMap: textureLoader.load('src/textures/plaster_roughness.jpg')
    };
